...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "pujun";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) { // 保证单线程创建用户
            // 账户不能重复
            ...
            String accessKey = DigestUtil.md5Hex16(SALT + userAccount + RandomUtil.randomNumbers(5));
            String secretKey = DigestUtil.md5Hex16(SALT + userAccount + RandomUtil.randomNumbers(4));
            // 3. 插入数据
            User user = new User();
